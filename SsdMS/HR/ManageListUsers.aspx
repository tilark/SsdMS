            ...
            <ContentTemplate>
                ...
                <asp:ListView runat="server" ID="lvInfoUser" ItemType="SsdMS.Models.InfoUser" DataKeyNames="InfoUserID"
                    ...
                    <LayoutTemplate>
                        ...
                        <asp:DataPager runat="server" PageSize="2"  ID="lvInfoUserDataPager">
                            <Fields>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Label runat="server" ID="lblPhone1" Visible="true" Text="<%# Item.Phone1 %>"></asp:Label>
                                <asp:Label ID="lblInfoUserID" runat="server" Text="<%# Item.InfoUserID %>" Visible="false"></asp:Label>
                            </td>
                            <td>
                                <asp:ListView ID="lvDepartmentDuty" runat="server" ItemType="SsdMS.Models.DepartmentDuty" DataKeyNames="DepartmentDutyID"
                                    SelectMethod="lvDepartmentDuty_GetData">
                                    <ItemTemplate>
